...
namespace AnalyzerTemplate
{
    ...
    public class AnalyzerI7Yield : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "AnalyzerI7Yield";
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(AnalyzeNode, YieldReturnStatement);
        }

        private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            var returnStatement = (YieldStatementSyntax) context.Node;
