...
namespace AnalyzerTemplate
{
    ...
    public class AnalyzerI7List : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "AnalyzerI7List";
        ...
        private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            ...
            var genericType = method.ReturnType.DescendantNodesAndSelf().OfType<GenericNameSyntax>().FirstOrDefault();
